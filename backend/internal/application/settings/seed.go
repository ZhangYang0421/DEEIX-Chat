...
func defaultSettings() []domainsettings.SystemSetting {
	return []domainsettings.SystemSetting{
		...
		{Namespace: "extract", Key: "paddle_ocr_base_url", Value: "https://paddleocr.aistudio-app.com/api/v2/ocr/jobs", ValueType: "string", Description: "PaddleOCR-VL 异步任务接口地址"},
		{Namespace: "extract", Key: "paddle_ocr_auth_token", Value: "", ValueType: "string", Description: "Paddle OCR 鉴权 Token"},
		{Namespace: "extract", Key: "paddle_ocr_timeout_seconds", Value: "600", ValueType: "int", Description: "PaddleOCR-VL 异步任务总超时(秒)，默认 600s"},
