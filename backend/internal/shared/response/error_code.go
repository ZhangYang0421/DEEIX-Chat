...
var codeMessages = map[string]string{
	...
	"file.processing_retry_not_allowed":             "file processing retry not allowed",
	"audio.transcription_retry_not_allowed":         "audio transcription retry not allowed",
	"transcript.not_ready":                          "transcript not ready",
	...
	"llm.image_input_unsupported":                   "model does not support image input",
	"transcript.revision_conflict":                  "transcript revision conflict",
	"transcript.invalid_edit":                       "invalid transcript edit",
